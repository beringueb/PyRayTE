...
update = False
fisher_matrices_root = '../data/fisher_matrices/CMB_HD_lmax/'
for lmax in lmax_list:
    for fsky in [0.25]:
        for rayleigh in ['True']:
            inifile = '../ini/CMB_HD_lmax/CMB_HD_v1_{:d}_{:3.2f}_{:s}.ini'.format(lmax,fsky,rayleigh)
            ...
            fisher_tot.write_to_txt(fisher_matrices_root, name = 'CMB_HD_lensed_pol_v1_{:d}'.format(lmax))
            update = False
